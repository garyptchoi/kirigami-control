% MRP_kagome_7x7: Construct a minimum rigidifying link pattern for 7x7
% kagome kirigami
%
% Reference:
...
linkpairs = Linkpairs([1:num_bdy_links, ...
42    31    33    35    37    39    43    48  ...
51    50    55    121    58    60    65    64   ...
69    106    72    73    79    81    87    90   ...
111    97   101   114   104   107   109   112    ...
118   119   126   127   129   123   133   132   ...
135   136   137   140   142   143   144   146],:); % optimal for (7,7)
